...
if (workflow.includes('\n  push:\n')) {
  fail(
    'package-unsigned-macos must stay manual-only; tag publication belongs to .github/workflows/release.yml',
  );
}
...
if (posture.githubArtifactName !== 'dataarm-unsigned-macos-apple-silicon-dmg') {
...
if (posture.signing !== 'disabled') {
  fail('GitHub packaging posture must remain unsigned');
}
