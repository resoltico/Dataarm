...
5. Load the application-framework protocol for each touched surface:
   - Tauri 2.11.x: `.codex/AGENTS_TAURI211.md` (v2.0.0+)
...
- Tauri 2.11.x apps, plugins, configuration, capabilities, permissions, bundling, updater/signing, mobile targets, and frontend/Rust IPC surfaces use `.codex/AGENTS_TAURI211.md` in addition to the Rust protocol and any applicable frontend language/framework norms.
